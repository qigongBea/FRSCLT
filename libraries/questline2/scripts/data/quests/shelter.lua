---@class MyQuest : Quest
local MyQuest, super = Class(Quest, "shelter")

function MyQuest:init()
    super.init(self)
    self.name = "Explore the Shelter"
    ...
    self.description = "You have everything you need to go to the shelter now! Investigate it and find a reasoning for the earthquakes."
...
function MyQuest:getDescription()
	if self:isCompleted() then
		return "You found out about a strange doctor who wants you dead. The unstable Gateway is most likely the reason for the earthquakes."
	end
