...
function ChapterSelect:draw()
    ...
    Draw.printAlign(Game:locRaw("ui_chapter_select_quit"), 210, 434)
    ...
    Draw.printAlign(Game:locRaw("ui_chapter_select_options"), 352, 434)
    love.graphics.push()
...
function ChapterSelect:drawChapter(index, chapter)
    love.graphics.print(Game:locRaw("ui_chapter_select_index_1")..chapter.index..Game:locRaw("ui_chapter_select_index_2"), 1, 1)
    ...
    if self.state == "CHAPTER" and self.selected_y == index then
        ...
        Draw.printAlign(Game:locRaw("ui_chapter_select_name_chapter_" .. chapter.index), 311, 1, "center")
        Draw.setColor(Game:getSoulColor())
